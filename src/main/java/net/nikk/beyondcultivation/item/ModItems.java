...
import net.nikk.beyondcultivation.item.custom.GourdItem;
import net.nikk.beyondcultivation.item.custom.PoisonFlaskItem;
import net.nikk.beyondcultivation.item.custom.SpiritStoneItem;
...
public class ModItems {
    public static final Item SPIRIT_STONE = registerItem("spirit_stone",
            new SpiritStoneItem(new FabricItemSettings()));
    ...
    public static final Item BOAR_SPAWN_EGG = registerItem("boar_spawn_egg",
            new SpawnEggItem(ModEntities.BOAR, 0xeeee2e, 0xf9f0ff, new FabricItemSettings()));

    public static final Item HUANCAT_SPAWN_EGG = registerItem("huancat_spawn_egg",
            new SpawnEggItem(ModEntities.HUANCAT, 0x6fef2e, 0x79f0ff, new FabricItemSettings()));

    public static final Item DRAGON_SPAWN_EGG = registerItem("dragon_spawn_egg",
            new SpawnEggItem(ModEntities.DRAGON, 0xffe22e, 0x29f0ff, new FabricItemSettings()));
    public static final Item TEST_POISON = registerItem("test_poison",
            new PoisonFlaskItem(new FabricItemSettings()));
    ...
    private static void itemGroupSpawnEgg(FabricItemGroupEntries entries) {
        ...
        entries.add(BOAR_SPAWN_EGG);
        entries.add(HUANCAT_SPAWN_EGG);
