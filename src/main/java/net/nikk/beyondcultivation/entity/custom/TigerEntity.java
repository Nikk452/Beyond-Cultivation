...
public class TigerEntity extends TameableEntity implements Mount {
    private static final TrackedData<Boolean> ATTACKING =
            DataTracker.registerData(TigerEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(TigerEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    private void setVariant(TigerVariant variant) {
