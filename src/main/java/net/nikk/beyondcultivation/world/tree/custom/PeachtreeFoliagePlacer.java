...
import net.nikk.beyondcultivation.world.tree.ModFoliagePlacerTypes;

public class PeachtreeFoliagePlacer extends FoliagePlacer {

    public static final Codec<PeachtreeFoliagePlacer> CODEC = RecordCodecBuilder.create((instance) -> fillFoliagePlacerFields(instance)
            .and(Codec.intRange(0, 12).fieldOf("height").forGetter((placer) -> placer.height)).apply(instance, PeachtreeFoliagePlacer::new));
    private final int height;

    public PeachtreeFoliagePlacer(IntProvider radius, IntProvider offset, int height) {
        super(radius, offset);
        this.height = height;
    }
    ...
    protected FoliagePlacerType<?> getType() {
        return ModFoliagePlacerTypes.PEACHTREE_FOLIAGE_PLACER;
    }
